...
% Eyelink
% ************************
if ~isfield(params, 'doEyelink') || isempty(params.doEyelink)
    params.doEyelink        = false; % Default to not use eyelink, unless requested
else
    params.doEyelink        = params.doEyelink;
end
